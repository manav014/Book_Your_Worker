...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="login" method="post">
    ...
    <div class="container">
      ...
      <input type="email" placeholder="Enter Email here" name="uname" required>

      <label><b>Password</b></label>
      <input type="password" placeholder="Enter Password here" name="pass" required>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate" action="register" method="post">
    ...
    <div class="container">
      ...
      <input type="number" placeholder="Enter  contact number Here" name="cno" min=1000000000 max=9999999999 required>
