        ...
        <div class="main-panel">
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Book your Carpenter</a>
                               <%  
                               if(arg.equals("done")){out.print("<h6>Successfully booked your carpainter</h6>");}%>
                    </div>
            ...
            <div class="content">
    			...
    			try
    			{
    				...
    				%>
                        <div class="col-md-4">
                          ...
                          <a href=http://localhost:8080/booking/send?tp=carpainter&email=<%out.println(rs.getString("email")); %>>
					<button type="button" class="btn btn-primary">Book This Carpainter</button></a>
                                </div>
    			...
    			catch(Exception e)
    			{
                    ...
                    if(i==0)
                    {
                    	out.println("<h2> Sorry no Carpainters available</h2>");
                    }
    			%>                  
                    </div>
                </div>
